...
final class Version20181017131824 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pomodoros_configuration (id INT AUTO_INCREMENT NOT NULL, break_time INT NOT NULL, working_time INT NOT NULL, end_break_alarm TINYINT(1) NOT NULL, end_work_alarm TINYINT(1) NOT NULL, clock_sound TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (asddas INT NOT NULL) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
