 ...
 */
final class Version20181113174747 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, secret_question_id INT DEFAULT NULL, report_frequency_id INT DEFAULT NULL, pomodoros_configuration_id INT DEFAULT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, secret_answer VARCHAR(255) NOT NULL, email VARCHAR(191) NOT NULL, UNIQUE INDEX UNIQ_C7440455E7927C74 (email), INDEX IDX_C744045534911AD5 (secret_question_id), INDEX IDX_C74404559AED00BB (report_frequency_id), UNIQUE INDEX UNIQ_C744045518828175 (pomodoros_configuration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clock (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, client_id INT NOT NULL, lap INT NOT NULL, pause_stamp DATETIME DEFAULT NULL, period_type VARCHAR(255) NOT NULL, previous_period VARCHAR(255) DEFAULT NULL, period_start_stamp DATETIME NOT NULL, deadline DATETIME NOT NULL, ready TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_BE7BBE928DB60186 (task_id), UNIQUE INDEX UNIQ_BE7BBE9219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pomodoro (id INT AUTO_INCREMENT NOT NULL, task_id INT DEFAULT NULL, start_date DATETIME NOT NULL, ending_date DATETIME DEFAULT NULL, INDEX IDX_2C4F05198DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pomodoros_configuration (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, break_time INT NOT NULL, working_time INT NOT NULL, end_break_alarm TINYINT(1) NOT NULL, end_work_alarm TINYINT(1) NOT NULL, clock_sound TINYINT(1) NOT NULL, long_break_time INT NOT NULL, UNIQUE INDEX UNIQ_2A8E1BA619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE clock ADD CONSTRAINT FK_BE7BBE928DB60186 FOREIGN KEY (task_id) REFERENCES task (id)');
        $this->addSql('ALTER TABLE clock ADD CONSTRAINT FK_BE7BBE9219EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE pomodoro ADD CONSTRAINT FK_2C4F05198DB60186 FOREIGN KEY (task_id) REFERENCES task (id)');
        $this->addSql('ALTER TABLE pomodoros_configuration ADD CONSTRAINT FK_2A8E1BA619EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clock DROP FOREIGN KEY FK_BE7BBE9219EB6921');
        $this->addSql('ALTER TABLE pomodoros_configuration DROP FOREIGN KEY FK_2A8E1BA619EB6921');
        ...
        $this->addSql('ALTER TABLE clock DROP FOREIGN KEY FK_BE7BBE928DB60186');
